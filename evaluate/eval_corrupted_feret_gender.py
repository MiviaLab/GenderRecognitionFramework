...
parser.add_argument('--outf', dest="outf", type=str, default="results/feret", help='Path of results file')
parser.add_argument('--time', action='store_true')
parser.add_argument('--inference', action='store_true')
parser.add_argument('--nocorruption', action='store_true')
args = parser.parse_args()

CORRUPTED_FERET_GENDER_BLOB = '../dataset/data/corrupted_feret_gender_dataset/feret_augmentation.*'
CORRUPTED_CACHE_DIR = "../dataset/cache/corrupted_feret_gender_cache/{augmentation}"
ORIGINAL_FERET_GENDER_BLOB = '../dataset/data/gender-feret'
