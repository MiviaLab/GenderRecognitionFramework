...
parser.add_argument('--outf', dest="outf", type=str, default="results/lfw", help='Path of results file')
parser.add_argument('--time', action='store_true')
parser.add_argument('--inference', action='store_true')
parser.add_argument('--nocorruption', action='store_true')
args = parser.parse_args()

CORRUPTED_LFW_PLUS_BLOB = '../dataset/data/corrupted_lfw_plus_dataset/lfw_plus.all.*'
CORRUPTED_CACHE_DIR = "../dataset/cache/corrupted_lfw_plus_gender_cache/{augmentation}"
LFW_PLUS_ORIGINAL = '../dataset/data/gender-access/lfw_cropped'
LFW_CSVMETA = '../dataset/data/gender-access/lfw_theirs_<gender>.csv'
